      ...
      <div className="">
        <div className="">
          ...
          <div className="container mx-auto pt-16">
            ...
            <div className="flex flex-col lg:flex-row px-5 lg:pt-8 lg:p-0 gap-y-6 lg:gap-y-0 lg:gap-x-36">
              <div className="">
                <h1 className="text-[#0d3c5a] text-center lg:text-left text-2xl lg:text-3xl mb-4 mt-6 lg:mt-8">
                  Lorem Ipsum
                </h1>
                <ul className="pt-2 px-4 lg:px-4 list-disc space-y-1">
            ...
            <div className="md:max-w-[700px] md:mx-auto lg:max-w-[1000px] xl:max-w-[1400px] lg:mx-auto">
              <h1 className="text-[#0d3c5a] text-center text-2xl lg:text-3xl mb-4 lg:mb-12 mt-12 lg:mt-14">
                Galeri
              </h1>
